...
exports.DriversModule = DriversModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([driver_profile_entity_1.DriverProfile, ride_entity_1.Ride, rating_entity_1.Rating]),
        ],
        controllers: [drivers_controller_1.DriversController],
        providers: [drivers_service_1.DriversService, driver_presence_service_1.DriverPresenceService],
        exports: [drivers_service_1.DriversService, driver_presence_service_1.DriverPresenceService],
    })
], DriversModule);
