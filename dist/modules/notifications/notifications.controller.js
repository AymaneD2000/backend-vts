...
let NotificationsController = class NotificationsController {
    ...
    async register(userId, dto) {
        await this.notifications.registerToken(userId, dto.token, dto.platform ?? device_token_entity_1.DevicePlatform.ANDROID);
        return { message: 'ok' };
    }
    async unregister(dto) {
...
__decorate([
    (0, common_1.Post)('tokens/remove'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [register_token_dto_1.UnregisterTokenDto]),
    __metadata("design:returntype", Promise)
], NotificationsController.prototype, "unregister", null);
